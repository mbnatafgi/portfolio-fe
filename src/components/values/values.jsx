            ...
            <div className="chart">
                <svg viewBox='0 0 697 697'>
                        <g transform="translate(348.909 0)">
                            <path d="M150,363.885V15A348.886,348.886,0,0,1,481.811,256.075L150,363.885" transform="translate(-150 -15)" fill="#fe0" stroke="#fff" stroke-width="5"/>
                        ...
                        <g transform="translate(348.909 241.075)">
                            <path d="M150,216.094,481.811,108.283A348.886,348.886,0,0,1,355.07,498.347L150,216.094" transform="translate(-150 -108.283)" stroke="#fff" stroke-width="5"/>
                        ...
                        <g transform="translate(143.839 348.885)">
                            <path d="M275.719,150l205.07,282.253a348.885,348.885,0,0,1-410.139,0L275.719,150" transform="translate(-70.649 -150)" fill="#2f3b4a" stroke="#fff" stroke-width="5"/>
                        ...
                        <g transform="translate(0 241.075)">
                            <path d="M363.9,216.094,158.83,498.347A348.885,348.885,0,0,1,32.09,108.283L363.9,216.094" transform="translate(-14.991 -108.283)" fill="#52f3d0" stroke="#fff" stroke-width="5"/>
                            <text transform="translate(31.865 169.622)" className='dark'><tspan x="0" y="0">Intellect</tspan></text>
                        </g>
                        <g transform="translate(17.099)">
                            <path d="M353.417,363.885,21.607,256.075A348.885,348.885,0,0,1,353.417,15V363.885" transform="translate(-21.607 -15)" fill="#4cf690" stroke="#fff" stroke-width="5"/>
